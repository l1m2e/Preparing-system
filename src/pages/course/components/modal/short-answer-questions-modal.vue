...
const saveButton = async () => {
	...
	//保存编辑器中的图片
	const imageIdList = [...getImageSrcId(topic.value), ...getImageSrcId(analysis.value), ...getImageSrcId(answer.value)]
...
<template>
	<a-modal :visible="show" title="添加简答题" :width="1200" okText="保存" cancelText="取消" :closable="false" :mask-closable="false" :esc-to-close="false" :footer="false">
